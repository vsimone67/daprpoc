...
namespace MibHub.Processor.Extensions
{
    public static class DiExtensions
    {
        public static IServiceCollection ConfigureDiEnvironment(this IServiceCollection services, IConfiguration Configuration)
        {
            ...
            //services.AddDbContext<DBContext>(options => options.UseSqlServer(Configuration.GetConnectionString("MibHub.Processor"), providerOptions => providerOptions.CommandTimeout(120)));
