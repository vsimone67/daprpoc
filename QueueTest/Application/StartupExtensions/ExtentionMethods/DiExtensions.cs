...
namespace QueueTest.Extensions
{
    public static class DiExtensions
    {
        public static IServiceCollection ConfigureDiEnvironment(this IServiceCollection services, IConfiguration Configuration)
        {
            ...
            //services.AddDbContext<DBContext>(options => options.UseSqlServer(Configuration.GetConnectionString("QueueTest"), providerOptions => providerOptions.CommandTimeout(120)));
